...
<div id="wrap" class="clearfix">
  ...
  <div id="copyright">
    <?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <a href="<?php print $front_page; ?>"><?php print $site_name; ?></a><?php print '&nbsp;'; ?> <a href="http://profilprofessionnel.com/" target="_blank">Gabriele Cassano</a>
  </div>
</div>